...
•  **profile**: [MiniProfile](_src_entities_mini_profile_entity_.miniprofile.md) \| [MicroProfile](_src_entities_mini_profile_entity_.microprofile.md)

*Defined in [src/entities/people-search-hit.entity.ts:5](https://github.com/dmitriy-qua/linkedin-private-api/blob/0548fcd/src/entities/people-search-hit.entity.ts#L5)*
